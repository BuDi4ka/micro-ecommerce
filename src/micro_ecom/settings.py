"""
Django settings for micro_ecom project.
...
DEBUG = config("DJANG0_DEBUG", cast=bool, default=False)
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "micro_ecom.context_processors.vendor_files",
            ],
        },
    },
]

WSGI_APPLICATION = "micro_ecom.wsgi.application"
